            ...
            ?>
                    <table class="table table-striped">
                        ...
                        do {
                            ...
                            echo "<td> <img class='mid' src='img/imgbdd/" . $fila['nombre'] . "'readonly ></td>";
                            ...
                            echo "<a class='btn btn-danger my-2' href='delete.php?id=" . $fila['id']."'>Eliminar</a></input>"; //Enlace necesario para poder eliminar el elemento por ID
                        } while ($fila = $sentencia->fetch());
                    }
                } else {
                    echo "<div class='error'><p>No hay ningun proyecto para validar</p></div>";
                }
                        ?>
                            </form>
                        </tbody>
